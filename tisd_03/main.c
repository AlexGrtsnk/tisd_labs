    ...
    while (cur_command != 0)
    {
        ...
        else
        {
            if (cur_command == 1)
            {
                ...
                printf("%s\n", "Введите элементы матрицы А в формате(отсчёт от нуля) 'строка столбец значение':");
                create(&matrix_a);
                ...
                printf("%s\n", "Введите элементы матрицы В(отчёт от нуля) в формате 'строка столбец значение':");
                create(&matrix_b);
